...
if(isset($_POST['reg']))
{
    $a=fopen("../document/galleryF","w");
    $aE=fopen("../document/galleryE","w");
    fwrite($a,$_POST["aboutUs"]);
    fwrite($aE,$_POST["aboutUsE"]);
    fclose($a);
    fclose($aE);
    $s="گالری با موفقیت ثبت شد";
    $a=fopen("../document/ZgalleryF","w");
    $aE=fopen("../document/ZgalleryE","w");
...
<div>
    <div style="height:30px;width:500px;margin:0 auto;"><p style="text-align:center;">
      ...
      ?>
        ...
        <?php
        $a=fopen("../document/galleryF","r");
        $aE=fopen("../document/galleryE","r");
        $txt="";
        $txtE="";
        while (!feof($a))
        {
        ...
        fclose($a);
        fclose($aE);
        $a=fopen("../document/ZgalleryF","r");
        $aE=fopen("../document/ZgalleryE","r");
        $Ztxt="";
        $ZtxtE="";
        while (!feof($a))
        {
