...
if(isset($_POST['reg']))
{
    $a=fopen("../document/labwareF","w");
    $aE=fopen("../document/labwareE","w");
    fwrite($a,$_POST["aboutUs"]);
    fwrite($aE,$_POST["aboutUsE"]);
    fclose($a);
    fclose($aE);
    $s="شیشه آلات با موفقیت ثبت شد";
    $a=fopen("../document/ZlabwareF","w");
    $aE=fopen("../document/ZlabwareE","w");
...
<div>
    <div style="height:30px;width:500px;margin:0 auto;"><p style="text-align:center;">
      ...
      ?>
        ...
        <?php
        $a=fopen("../document/labwareF","r");
        $aE=fopen("../document/labwareE","r");
        $txt="";
        $txtE="";
        while (!feof($a))
        {
        ...
        fclose($a);
        fclose($aE);
        $a=fopen("../document/ZlabwareF","r");
        $aE=fopen("../document/ZlabwareE","r");
        $Ztxt="";
        $ZtxtE="";
        while (!feof($a))
        {
